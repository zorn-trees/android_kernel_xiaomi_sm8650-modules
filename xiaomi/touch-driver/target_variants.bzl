...
def get_all_device_variants():
    return [(t, v) for t in xiaomi_devices for v in la_variants]
...
def get_all_variants():
    return get_all_la_variants() + get_all_le_variants() + get_all_vm_variants() + get_all_device_variants()
