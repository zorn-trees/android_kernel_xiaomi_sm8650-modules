...
#define FTS_FW_NAME_PREX_WITH_REQUEST               "focaltech_ts_fw_zorn"

/*****************************************************************************
* Global variable or extern global variabls/functions
*****************************************************************************/
/* Zorn firmware is supplied through request_firmware(), never embedded. */
u8 fw_file[] = {};
u8 fw_file2[] = {};
u8 fw_file3[] = {};
...
#if (defined CONFIG_FACTORY_BUILD) && (defined USER_DEBUG_BUILD)
...
static int fts_read_file(char *file_name, u8 **file_buf)
{
    ...
    if (ret < 0) {
/* NOTE: gki doesn't allow filp_open in user build, comment if compilation failed */
#if LINUX_VERSION_CODE < KERNEL_VERSION(5,10,0)
#if (defined CONFIG_FACTORY_BUILD) && (defined USER_DEBUG_BUILD)
