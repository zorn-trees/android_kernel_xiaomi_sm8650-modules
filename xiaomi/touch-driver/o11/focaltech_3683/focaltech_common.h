...
*****************************************************************************/
#define FTS_DRIVER_VERSION                  "Focaltech V3.4 20241129"
...
extern enum FTS_LOG_LEVEL debug_log_level;
#define FTS_DEBUG(fmt, args...) {if (debug_log_level > FTS_LOG_INFO) pr_info("[FTS_TS/D]%s:" fmt "\n", __func__, ##args);}
