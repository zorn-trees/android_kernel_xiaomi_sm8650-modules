...
#define GOODIX_DRIVER_VERSION			"gt9615-2025.05.06-01"
...
#define GOODIX_NORMAL_RESET_DELAY_MS	103
...
#define TS_DEFAULT_FIRMWARE			"goodix_firmware_popsicle_csot.bin"
#define TS_DEFAULT_CFG_BIN 			"goodix_cfg_group_popsicle_csot.bin"
...
/* enable tic dump sync n12*/
/*#define CONFIG_TOUCH_BOOST*/

#define GOODIX_THP_FRAME_SIZE			1024
...
struct tp_frame {
	...
	int dump_type;
	u8 thp_debug[GOODIX_THP_FRAME_SIZE];
